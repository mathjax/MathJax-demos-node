    ...
    hooks: {
      ...
      args(args) {
        ...
        if (Util.direct && args.mml3) {
          Util.import(`@mathjax/src/js/input/mathml/mml3/mml3.js`);
        }
      },
  ...
  output: {
    ...
    hooks: {
      ...
      args(args) {
        ...
        //
        if (Util.direct) {
          const {SerializedMmlVisitor} = Util.import('@mathjax/src/js/core/MmlTree/SerializedMmlVisitor.js');
