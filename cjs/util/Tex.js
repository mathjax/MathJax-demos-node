...
//
const {mjxRoot} = require('@mathjax/src/js/components/cjs/root.js');
const {readdirSync, existsSync} = require('node:fs');

/**
 * The TeX utility object.
 */
const Tex = exports.Tex = {
  /**
  ...
  loadDirect(args) {
    ...
    //
    const root = mjxRoot().replace(/bundle$/, 'cjs/input/tex');
    //
